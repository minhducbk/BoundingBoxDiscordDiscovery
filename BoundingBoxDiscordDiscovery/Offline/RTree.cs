...
namespace BoundingBoxDiscordDiscovery.Offline
{
    public class RTree<T>
    {
        ...
        private void condenseTree(Node<T> l)
        {
            ...
            Node<T> parent = null;
            int parentEntry = 0;
            Rectangle oldRectangle = new Rectangle(n.mbr.min.Length); // just added. May be lead to error in line oldRectangle.set.... below
        ...
        */
        ...
        private void pickSeeds(Node<T> n, Rectangle newRect, int newId, Node<T> newNode)
        {
            ...
            for (int d = 0; d < newRect.DIMENSIONS; d++)
            {
